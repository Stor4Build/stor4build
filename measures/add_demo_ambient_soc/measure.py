...
class AddDemoAmbientSoc(openstudio.measure.EnergyPlusMeasure):
    ...
    def description(self):
        ...
        """
        return "Add the demo Python plugin that runs a TES system and modifies the operation according to the ambient temp and state of charge."
    ...
    def run(
        ...
        obj.setString(1, 'No')
        obj.setString(2, "demo_ambient_soc")
        obj.setString(3, "AmbientSoc")
...
AddDemoAmbientSoc().registerWithApplication()
