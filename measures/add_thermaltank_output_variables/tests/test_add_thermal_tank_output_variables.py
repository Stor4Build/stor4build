...
from measure import AddThermalTankOutputVariables


class TestAddThermalTankOutputVariables:
    """Py.test module for AddThermalTankOutputVariables."""

    def test_number_of_arguments_and_argument_names(self):
        """Test that the arguments are what we expect."""
        # create an instance of the measure
        measure = AddThermalTankOutputVariables()
