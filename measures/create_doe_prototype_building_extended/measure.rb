...
# Start the measure
class CreateDOEPrototypeBuildingExtended < OpenStudio::Measure::ModelMeasure
  require 'openstudio-standards'

  # Define the name of the Measure.
  def name
    return 'Create DOE Prototype Building Extended'
  end
  ...
  def arguments(model)
    ...
    building_type_chs << 'SmallOfficeDetailed'
    building_type_chs << 'MediumOfficeDetailed'
    building_type_chs << 'LargeOfficeDetailed'
...
CreateDOEPrototypeBuildingExtended.new.registerWithApplication
